  ...
  return {
    ...
    devProjects: [
      // ==================== 进度超前项目 (AHEAD) ====================
      {
        ...
        aiRecommendation: "Satellite imagery confirms +28% velocity vs baseline. LiDAR shows structural integrity ahead of schedule.",
        aiAction: "PROCEED TO PHASE 2",
        spatialChange: [
      ...
      },
      {
        ...
        aiRecommendation: "Aerial survey detects preservation work +18% ahead. Ground sensors confirm visitor capacity ready.",
        aiAction: "ACCELERATE TOURISM LAUNCH",
        spatialChange: [
      ...
      // ==================== 进度落后项目 (DELAYED) ====================
      {
        ...
        status: "delayed",
        // 计划进度: (2026-2021+1)/(2030-2021+1) = 6/10 = 60%
        aiRecommendation: "LiDAR reveals foundation delays due to soil composition. Thermal imaging shows equipment idle 42%.",
        aiAction: "+25% WORKFORCE URGENT",
        spatialChange: [
      ...
      },
      {
        ...
        aiRecommendation: "Ground-penetrating radar detects unstable substrate. Satellite shows material delivery -35% vs plan.",
        aiAction: "ENGINEERING REVIEW NEEDED",
        spatialChange: [
      ...
      // ==================== 正常推进项目 (ON TRACK) ====================
      {
        ...
        status: "on-track",
        // 计划进度: (2026-2022+1)/(2028-2022+1) = 5/7 = 71.4%
        aiRecommendation: "Geospatial data confirms timeline alignment. Drone surveys show coral preservation on track.",
        aiAction: "MAINTAIN CURRENT PACE",
        spatialChange: [
      ...
      },
      {
        ...
        aiRecommendation: "Satellite tracking shows steady construction. LiDAR confirms ride foundations completed.",
        aiAction: "ON SCHEDULE FOR Q4 OPENING",
        spatialChange: [
    ...
    greenSpaceRegional: [
      { region: "RIYADH", current: 12.8, target: 15.0, growth: 0.6, status: "on-track" },
      { region: "JEDDAH", current: 11.5, target: 15.0, growth: 0.5, status: "attention" },
      { region: "MECCA", current: 14.2, target: 15.0, growth: 0.8, status: "exceeding" },
      { region: "MEDINA", current: 13.8, target: 15.0, growth: 0.7, status: "on-track" },
      { region: "DAMMAM", current: 10.8, target: 15.0, growth: 0.4, status: "critical" },
      { region: "TABUK", current: 15.5, target: 15.0, growth: 1.2, status: "exceeding" },
    ],
    ...
    capexProjects: [
      { 
        id: 1, 
        name: "Riyadh Metro Extension PH2", 
        code: "RME-PH2",
        idleRate: 78.5, 
        budget: 4.2, 
        spent: 1.8, 
      ...
      { 
        id: 2, 
        name: "Jeddah Waterfront Dev PH3", 
        code: "JWD-PH3",
        idleRate: 68.4, 
        budget: 3.8, 
        spent: 2.1, 
    ...
    >
      ...
      <div className="relative z-10 w-full h-full pt-[80px] pb-4 px-4 flex flex-col min-h-0 gap-4 pointer-events-auto">
        ...
        <div className="flex-[0.52] flex gap-4 min-h-0">
          ...
          >
            <WidgetPanel title="SPATIAL TRUTH (Change Tracker Agent)" icon={<Eye className="w-4 h-4 text-[#3B82F6]" />} className="flex-1 min-h-0">
          ...
          >
            <WidgetPanel title="CAPEX UTILIZATION & ASSET LIFECYCLE (Condition Watch Agent)" icon={<Building2 className="w-4 h-4 text-[#FCD34D]" />} className="flex-1 min-h-0">
              <div className="flex h-full min-h-0 p-2.5 gap-3">
                ...
                <div className="w-[28%] flex flex-col min-h-0">
                  <div className="text-[9px] text-[#FCD34D] font-bold tracking-widest mb-1.5 px-1">PROJECTS BY IDLE RATE</div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-[8px] text-gray-500">Idle:</span>
                ...
                <div className="flex-1 flex flex-col min-h-0 gap-2">
                  ...
                  <div className="flex items-center justify-between px-2 py-1.5 bg-[#1e293b]/50 rounded border border-[#FCD34D]/20">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[9px] text-gray-500">{selectedProject.code} | Budget: {selectedProject.budget}B SAR | Spent: {selectedProject.spent}B SAR</span>
                    </div>
                  ...
                  <div className="flex gap-2 shrink-0">
                    <div className="flex-1 flex items-center gap-2 px-2 py-1.5 bg-[#FCD34D]/10 border border-[#FCD34D]/30 rounded">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[8px] text-gray-500">Idle Rate</span>
                      </div>
                    </div>
                    <div className="flex-1 flex items-center gap-2 px-2 py-1.5 bg-white/5 border border-white/20 rounded">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[8px] text-gray-500">ROI Target</span>
                      </div>
                    </div>
                    <div className="flex-1 flex items-center gap-2 px-2 py-1.5 bg-[#3B82F6]/10 border border-[#3B82F6]/30 rounded">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[8px] text-gray-500">Current Phase</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 min-h-0 border border-[#FCD34D]/20 rounded-md p-2 hover:border-[#FCD34D]/40 transition-all">
                    <div className="text-[9px] text-[#FCD34D] font-bold tracking-widest mb-1">ASSET LIFECYCLE YIELD (12 MONTHS)</div>
                    <div className="h-[calc(100%-20px)]">
                      <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={selectedProject.yieldData} margin={{ top: 10, right: 5, bottom: 5, left: -15 }}>
                          ...
                          <Bar dataKey="actual" name="Actual Use" fill="#FCD34D" fillOpacity={0.85} barSize={14} radius={[2, 2, 0, 0]}>
        ...
        <div className="flex-[0.48] flex gap-4 min-h-0">
          ...
          <motion.div 
            ...
            className="w-[25%] flex flex-col min-w-0 h-full"
          >
            <WidgetPanel title="CARRYING CAPACITY (Continuous Learning Agent)" icon={<BrainCircuit className="w-4 h-4 text-[#FCD34D]" />} className="flex-1 min-h-0">
              <div className="flex flex-col h-full min-h-0 p-3 gap-3">
                <div className="flex gap-3 shrink-0">
          ...
          >
            <WidgetPanel title="DEVELOPMENT PIPELINE (Urban Monitoring Module)" icon={<Activity className="w-4 h-4 text-[#00B558]" />} className="flex-1 min-h-0">
              <div className="flex h-full min-h-0 p-2.5 gap-3">
                {/* Left: Project List (sorted by progress) */}
                <div className="w-[42%] flex flex-col min-h-0">
                  <div className="text-[9px] text-[#00B558] font-bold tracking-widest mb-1.5 px-1">VISION 2030 GIGA PROJECTS</div>
                  <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar space-y-1.5">
                        ...
                        >
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className={`text-[8px] px-1.5 py-0.5 rounded font-bold ${
                              ...
                              {project.status === 'ahead' ? 'AHEAD' : project.status === 'on-track' ? 'ON TRACK' : 'DELAYED'}
                            </span>
                          </div>
                          <div className="flex items-center gap-2">
                ...
                <div className="flex-1 flex flex-col min-h-0 gap-2">
                  ...
                  <div className="flex-1 min-h-0 border border-[#00B558]/20 rounded-md p-2">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <span className="text-[9px] text-[#00B558] font-bold tracking-widest">GEOSPATIAL TRACKING</span>
                        <span className="text-[7px] px-1.5 py-0.5 bg-[#3B82F6]/20 text-[#3B82F6] rounded">SATELLITE+LiDAR</span>
                      </div>
                      <span className="text-[8px] text-gray-500">Last Scan: Dec 2026</span>
                    </div>
                    <div className="h-[calc(100%-20px)]">
                      <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart 
                        ...
                        >
                          ...
                          />
                          <ReferenceLine x="2026" stroke="#FF4444" strokeDasharray="3 3" strokeOpacity={0.5} label={{ position: 'top', value: 'NOW', fill: '#FF4444', fontSize: 8, fontWeight: 'bold' }} />
                          <Line type="monotone" dataKey="planProgress" name="Planned" stroke="#3B82F6" strokeWidth={2} strokeDasharray="6 3" dot={{ r: 3, fill: '#3B82F6' }} />
                          <Line type="monotone" dataKey="actualProgress" name="Actual" stroke="#00B558" strokeWidth={2.5} dot={{ r: 4, fill: '#00B558' }} activeDot={{ r: 6, fill: '#00B558', stroke: '#020603', strokeWidth: 2 }} connectNulls={false} />
                        </ComposedChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
                  ...
                  <div className={`shrink-0 flex flex-col gap-1.5 px-3 py-2 rounded border ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-[8px] text-gray-500">Next Scan: Jan 2027</div>
                    </div>
          ...
          <motion.div
            ...
            className="w-[25%] flex flex-col min-w-0 h-full"
          >
            <WidgetPanel title="LAND USE TRANSFORMATION (Change Tracker Agent)" icon={<Layers className="w-4 h-4 text-[#FF4444]" />} className="flex-1 min-h-0">
              <div className="flex flex-col h-full min-h-0 p-2.5 gap-2">
                ...
                <div className="flex gap-2 shrink-0">
                  <div className="flex-1 flex items-center gap-2 px-2 py-1.5 bg-[#3B82F6]/10 border border-[#3B82F6]/30 rounded">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[8px] text-gray-500">Urban Area</span>
                    </div>
                  </div>
                  <div className="flex-1 flex items-center gap-2 px-2 py-1.5 bg-[#00B558]/10 border border-[#00B558]/30 rounded">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[8px] text-gray-500">Growth/Yr</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 min-h-0 border border-[#FF4444]/20 rounded-md p-2 hover:border-[#FF4444]/40 transition-all">
                  <div className="text-[9px] text-[#FF4444] font-bold tracking-widest mb-1">LAND USE EVOLUTION (2017-2026)</div>
                  <div className="h-[calc(100%-20px)]">
                    <ResponsiveContainer width="100%" height="100%">
                      <ComposedChart data={data.landUseChange} margin={{ top: 5, right: 5, bottom: 5, left: -15 }}>
                        ...
                        <Tooltip content={<CustomTooltip unit=" KM²" />} cursor={{ stroke: '#334155', strokeWidth: 1, strokeDasharray: '4 4' }} />
                        <ReferenceLine x="2024" stroke="#FF4444" strokeDasharray="3 3" strokeOpacity={0.4} label={{ position: 'top', value: 'FORECAST', fill: '#FF4444', fontSize: 8, fontWeight: 'bold' }} />
                        <Area type="monotone" dataKey="residential" name="Residential" stroke="#3B82F6" strokeWidth={2} fill="#3B82F6" fillOpacity={0.25} />
                        <Line type="monotone" dataKey="commercial" name="Commercial" stroke="#FCD34D" strokeWidth={2} dot={{ r: 2, fill: '#FCD34D' }} />
                        <Line type="monotone" dataKey="green" name="Green Space" stroke="#00B558" strokeWidth={2.5} dot={{ r: 3, fill: '#00B558' }} />
                      </ComposedChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                <div className="shrink-0">
                  <div className="text-[9px] text-[#00B558] font-bold tracking-widest mb-1.5">GREEN SPACE BY REGION</div>
